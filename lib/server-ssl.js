 ...
 * @param {string} args.key - Path to the SSL private key file.
 * @param {string} args.cert - Path to the SSL certificate file.
 ...
 * @returns {Promise<import('net').Server>} The created HTTPS server.
 */
